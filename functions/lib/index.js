...
exports.setAdminClaim = functions.https.onCall(async (data, context) => {
    ...
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'You must be authenticated to set admin claims');
    }
    const { uid, admin: isAdmin } = data;
    // Validate input
    if (!uid || typeof isAdmin !== 'boolean') {
        throw new functions.https.HttpsError('invalid-argument', 'Invalid arguments: uid and admin boolean are required');
    }
    try {
